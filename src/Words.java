...
/**
 * This class is responsible for takings words from a file and putting them into
 * a map and also keeping track of the word lengths, this class is basically an
 * iterator to read from a file
 *
 * @author jasontran
 */
public class Words {
     ...
     * @return true if there are words of a wordLength false otherwise
     */
